...
class SkEval(Enum):
    ...
    d2_absolute_error_score = RegressionEval(sk.d2_absolute_error_score)
    d2_pinball_score = RegressionEval(sk.d2_pinball_score)
    d2_tweedie_score = RegressionEval(sk.d2_tweedie_score)
