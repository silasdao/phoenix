...
def test_get_descendant_span_ids() -> None:
    ...
    assert not set(mock.get_descendant_span_ids(span_ids[0]))
    ...
    assert not set(mock.get_descendant_span_ids(span_ids[3]))
    assert set(mock.get_descendant_span_ids(span_ids[4])) == set(span_ids[5:])
    assert not set(mock.get_descendant_span_ids(span_ids[5]))
